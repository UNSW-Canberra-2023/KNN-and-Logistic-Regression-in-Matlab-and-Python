601,100
602,"}tp_workflow__submit-leaf-children__classic_approval"
562,"NULL"
586,
585,
564,
...
#******
#******
#***BEGIN(Prolog): }tp_workflow__submit-leaf-children__classic_approval
#******
...
If (cNodeType @= 'C');
	If ((cState @= '1' % cState @= '2') & (cgView @= 'T'));
		...
		vSubset = 'submit-leaf-children_ALL_LEAF_CHILDREN' | pTime;
...
EndIf;
#******
#***END(Prolog): }tp_workflow__submit-leaf-children__classic_approval
#******
