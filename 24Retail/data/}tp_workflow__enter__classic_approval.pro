601,100
602,"}tp_workflow__enter__classic_approval"
562,"NULL"
586,
585,
564,
...
#******
#******
#***BEGIN(Prolog): }tp_workflow__enter__classic_approval
#******
...
If (cNodeType @= 'N');
	...
	If ((cState @= '4') & (cgReject @= 'T'));
		...
		#*** Set State Member Info
		CellPutS('Y', cStateCube, cStateMember, 'Reviewed');
	EndIf;
...
ElseIf (cNodeType @= 'C');
	...
	If ((cState @= '1' % cState @= '0' % cState @= '' % cState @= '2') & (cgView @= 'T'));
		vVisitCount = vVisitCount + 1;
		vSubset = 'enter_ALL_LEAF_CHILDREN' | pTime;
...
EndIf;
#******
#***END(Prolog): }tp_workflow__enter__classic_approval
#******
