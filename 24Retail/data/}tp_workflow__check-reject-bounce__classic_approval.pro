601,100
602,"}tp_workflow__check-reject-bounce__classic_approval"
562,"NULL"
586,
585,
564,
...
#******
#******
#***BEGIN(Prolog): }tp_workflow__check-reject-bounce__classic_approval
#******
...
If (cNodeType @= 'N');
	If ((cState @= '4') & (cgReject @= 'T'));
		...
		If (DIMIX('}Clients', cCurrentOwnerId) <> 0);

			#*** set check bounce message only
			StringGlobalVariable('gCheckBouncingOnly');
			gCheckBouncingOnly = 'Y';
...
EndIf;
#******
#***END(Prolog): }tp_workflow__check-reject-bounce__classic_approval
#******
