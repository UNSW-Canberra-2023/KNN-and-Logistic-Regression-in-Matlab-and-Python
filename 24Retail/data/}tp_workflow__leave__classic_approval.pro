601,100
602,"}tp_workflow__leave__classic_approval"
562,"NULL"
586,
585,
564,
...
#******
#******
#***BEGIN(Prolog): }tp_workflow__leave__classic_approval
#******
...
ElseIf (cNodeType @= 'C');
	...
	If ((cState @= '1' % cState @= '2') & (cgView @= 'T'));
		vVisitCount = vVisitCount + 1;
		vSubset = 'leave_ALL_LEAF_CHILDREN' | pTime;
...
EndIf;
#******
#***END(Prolog): }tp_workflow__leave__classic_approval
#******
