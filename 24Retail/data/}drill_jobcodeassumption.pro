601,100
602,"}Drill_JobCodeAssumption"
562,"VIEW"
586,"Job Code Assumptions"
585,"Job Code Assumptions"
564,
...
0
582,5
IgnoredInputVarName=jobcodeVarType=32ColType=1165
IgnoredInputVarName=JobCodeAsmptVarType=32ColType=1165
...
Job=DimensionElementPrincipalName('JobType',CELLGETS('Employee',organization,employeelist,pyear,version,'Job Code'));

IF(SubsetGetSize('JobCode','Drill')>0);
SubsetDeleteAllElements('JobCode','Drill');
ENDIF;
SubsetElementInsert('JobCode','Drill',Job,1);
...
#****Begin: Generated Statements***
RETURNVIEWHANDLE('Job Code Assumptions','Drill');
#****End: Generated Statements****
